...
database. The process itself consists of conversion from our codemeta
representation to whatever representation is suited for the catalogue system.

%TODO: two or three paragraphs on the Ineo pipeline and the CMDI/VLO pipeline?

%TODO: propagation to SSHOC marketplace
